/** \file main.c
 *  \brief Hlavní program pro testování ADT TSet - (realizace množiny pomocí setøídìného pole)
 *  \author Petyovský
 *  \version 2026
 ...
 * Pøíklad výstupu programu pro soubor `testplan_set1.h` pøi `FLEX_ARRAY_SEARCH_VARIANT == LINEAR_SEARCH_OPTIMIZED`.
 */
 /** \example cv11_reports_TSet_sorted_dynamic_array_set1_binary_search.lst
  * Pøíklad výstupu programu pro soubor `testplan_set1.h` pøi `FLEX_ARRAY_SEARCH_VARIANT == BINARY_SEARCH`.
  */

  /** \example cv11_reports_TSet_sorted_dynamic_array_set2_linear_search_optimized.lst
   * Pøíklad výstupu programu pro soubor `testplan_set2.h` pøi `FLEX_ARRAY_SEARCH_VARIANT == LINEAR_SEARCH_OPTIMIZED`.
   */
   /** \example cv11_reports_TSet_sorted_dynamic_array_set2_binary_search.lst
	* Pøíklad výstupu programu pro soubor `testplan_set2.h` pøi `FLEX_ARRAY_SEARCH_VARIANT == BINARY_SEARCH`.
	*/

	/** \example cv11_reports_TSet_sorted_dynamic_array_set3_linear_search_optimized.lst
	 * Pøíklad výstupu programu pro soubor `testplan_set3.h` pøi `FLEX_ARRAY_SEARCH_VARIANT == LINEAR_SEARCH_OPTIMIZED`.
	 */
	 /** \example cv11_reports_TSet_sorted_dynamic_array_set3_binary_search.lst
	  * Pøíklad výstupu programu pro soubor `testplan_set3.h` pøi `FLEX_ARRAY_SEARCH_VARIANT == BINARY_SEARCH`.
	  */
