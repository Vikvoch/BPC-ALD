 ...
 *  \author Petyovský
 *  \version 2026
 *  $Id: TVector.c 3274 2026-03-19 13:29:33Z petyovsky $
 */
...
[[nodiscard]] static inline bool vector_fast_print_sortstats_item(const struct TVectorSortStatsItem *aSortStatsItem, FILE *aOutputFile, const char aUsingStr[])
	{
...
bool vector_print_sortstats(const struct TVector *aVector, FILE *aOutputFile)
	{
	if(!aVector || !aOutputFile)
		return false;
	...
	return vector_fast_print_sortstats_item(&aVector->iStats->iByPosition, aOutputFile, "positions")
		&& vector_fast_print_sortstats_item(&aVector->iStats->iByIterator, aOutputFile, "iterators");
	}
