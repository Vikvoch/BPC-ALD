...
#define TQUEUE_ELEMENT_FRMSTR "%d"			///< Definice formátovacího řetězce pro souborové operace s typem QueueElement
...
/** \brief Zavolání zvolené funkce na prvních N elementů fronty od pozice určené iterátorem
 *  \details Zavolá zadanou funkci \p aOperation na prvních \p aN elementů fronty v rozsahu od pozice určené iterátorem. Pokud má fronta méně než \p aN elementů, funkce se ukončí dříve a vrátí neplatný iterátor.
 *  \param[in] aIter Ukazatel na existující iterátor, jenž je předem asociovaný se zvolenou frontou a který tak definuje počáteční element pro zvolenou operaci
 *  \param[in] aN Hodnota udávající počet prvních N elementů fronty, na které se má zavolat funkce \p aOperation
 *  \param[in] aOperation Ukazatel na funkci vracející \c void a mající jeden parametr typu ukazatel na iterátor
