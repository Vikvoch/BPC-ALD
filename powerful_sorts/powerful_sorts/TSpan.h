 ...
 *  \author Petyovský
 *  \version 2026
 *  $Id: TSpan.h 3328 2026-04-10 12:15:33Z petyovsky $
 */
 ...
 */
[[nodiscard]] static inline TSpanElement span_value(const struct TSpan *aSpan, size_t aPos)
	{
 ...
 *  \attention Funkce ověřuje platnost ukazatele a rozsah parametru \p aPos \b pouze při překladu v režimu `Debug`, kdy pomocí `assert` hlásí běhovou chybu!
 */
static inline void span_set_value(struct TSpan *aSpan, size_t aPos, TSpanElement aValue)
	{
 ...
 */
[[nodiscard]] static inline int span_compare_position_value(const struct TSpan *aSpan, size_t aPos, TSpanElement aValue)
	{
 ...
 */
static inline void span_swap_position_value(struct TSpan *aSpan, size_t aPos, TSpanElement *aValue)
	{
