/** \file main.c
 *  \brief Hlavní program pro testování ADT TSet - (realizace množiny pomocí nesetøídìného pole)
 *  \author Petyovský
 *  \version 2026
 ...
 * Pøíklad výstupu programu pro soubor `testplan_set1.h`.
 */

 /** \example cv11_reports_TSet_unsorted_dynamic_array_set2.lst
  * Pøíklad výstupu programu pro soubor `testplan_set2.h`.
  */
