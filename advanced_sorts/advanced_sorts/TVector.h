...
/** \brief Uložení do souboru (zobrazení) hodnoty statistik počtu operací s elementy vektoru
 *  \details Uloží do souboru (vytiskne na konzolu, pokud `aOutputFile = stdout`) celkové počty operací provedených s elementy vektoru.
 ...
 *  \details Zavolá zadanou funkci \p aOperation na prvních \p aN elementů vektoru od počáteční pozice určené iterátorem. Pokud má vektor méně než \p aN elementů, funkce se ukončí dříve a vrátí neplatný iterátor.
 *  \param[in] aIter Ukazatel na existující iterátor
 *  \param[in] aN Hodnota udávající počet prvních N elementů vektoru, na které se má zavolat funkce \p aOperation
 *  \param[in] aOperation Ukazatel na funkci vracející \c void a mající jeden parametr typu ukazatel na iterátor
