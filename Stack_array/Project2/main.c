 ...
 *  \details Testovací funkce pro API Stack. Funkce naèítá z konzoly znaky, které ukládá po slovech do zásobníku. Slovo obsahuje pouze písmena a èíslice. Po nalezení konce slova, následnì znaky ze zásobníku vybírá, ruší a tiskne.
 */
